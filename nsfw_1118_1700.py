"""
Mask R-CNN
Train on the nsfw robot dataset.
...
Usage: import the module (see Jupyter notebooks for examples), or run from
    ...
    python nsfw.py train --dataset=/home/.../mask_rcnn/data/nsfw/ --weights=coco

    #Train a new model starting from pre-trained ImageNet weights
    python nsfw.py train --dataset=/home/.../mask_rcnn/data/nsfw/ --weights=imagenet

    # Continue training the last model you trained. This will find
    # the last trained weights in the model directory.
    python nsfw.py train --dataset=/home/.../mask_rcnn/data/nsfw/ --weights=last
    ...
    python nsfw.py splash --weights=last --image=/home/...../*.jpg
...
class nsfwDataset(utils.Dataset):
    def load_VIA(self, dataset_dir, subset, hc=False):
        """Load the nsfw dataset from VIA.
        dataset_dir: Root directory of the dataset.
        subset: Subset to load: train or val or predict
        """
        # Add classes. We have only one class to add.
        self.add_class("nsfw", 1, "breast")
        self.add_class("nsfw", 2, "bra_cleavge")
        self.add_class("nsfw", 3, "cleavge")
        self.add_class("nsfw", 4, "nippler_cover")
        self.add_class("nsfw", 5, "bra_back")
        self.add_class("nsfw", 6, "butt_naked")
        self.add_class("nsfw", 7, "butt_briefs")
        self.add_class("nsfw", 8, "brief_private")
        self.add_class("nsfw", 9, "butt_cover")
        self.add_class("nsfw", 10, "private_shape")
    ...
    def load_mask(self, image_id):
       ...
       Returns:
        ...
        """
        # If not a nsfw dataset image, delegate to parent class.
        image_info = self.image_info[image_id]
        if image_info["source"] != "nsfw":
...
def train(model, *dic):
    """Train the model."""
    # Training dataset.
    dataset_train = nsfwDataset()
    dataset_train.load_VIA(args.dataset, "train")
    dataset_train.prepare()

    # Validation dataset
    dataset_val = nsfwDataset()
...
def detect_and_color_splash(model, image_path=None, video_path=None, out_dir=''):
    ...
    class_names = ['BG', 'breast', 'bra_cleavge', 'cleavge', 'nippler_cover', 'bra_back', 'butt_naked', 'butt_briefs', 'brief_private', 'butt_cover', 'private_shape', 'penis_model', 'penis_toy', 'half_naked']
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', required=False,
                        metavar="/home/simon/mask_rcnn/data/nsfw",
                        help='Directory of the nsfw dataset')
